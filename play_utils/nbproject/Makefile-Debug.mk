...
LDLIBSOPTIONS=-Wl,-rpath,../../tron/tron_tools/dist/Debug/GNU-Linux -L../../tron/tron_tools/dist/Debug/GNU-Linux -ltron_tools

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libplay_utils.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libplay_utils.${CND_DLIB_EXT}: ../../tron/tron_tools/dist/Debug/GNU-Linux/libtron_tools.so
...
${OBJECTDIR}/src/play/utils/CellActuator.o: src/play/utils/CellActuator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/play/utils/CellActuator.o src/play/utils/CellActuator.cpp

${OBJECTDIR}/src/play/utils/CellSensor.o: src/play/utils/CellSensor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/play/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/play/utils/CellSensor.o src/play/utils/CellSensor.cpp
