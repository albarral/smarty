...
${OBJECTDIR}/src/smart/agent/Agent.o: src/smart/agent/Agent.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../smart_task/src -I../../tron/tron_control/src -I../../tron/tron_space/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smart/agent/Agent.o src/smart/agent/Agent.cpp
...
${OBJECTDIR}/src/smart/agent/core/SmartConfig.o: src/smart/agent/core/SmartConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smart/agent/core
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../smart_task/src -I../../tron/tron_control/src -I../../tron/tron_space/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smart/agent/core/SmartConfig.o src/smart/agent/core/SmartConfig.cpp
...
${OBJECTDIR}/src/smart/agent/modules/Aware.o: src/smart/agent/modules/Aware.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../smart_task/src -I../../tron/tron_control/src -I../../tron/tron_space/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smart/agent/modules/Aware.o src/smart/agent/modules/Aware.cpp
