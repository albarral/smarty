...
LDLIBSOPTIONS=-Wl,-rpath,../../tron/tron_db/dist/Debug/GNU-Linux -L../../tron/tron_db/dist/Debug/GNU-Linux -ltron_db -lmysqlcppconn -lopencv_core

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsmart_learn.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsmart_learn.${CND_DLIB_EXT}: ../../tron/tron_db/dist/Debug/GNU-Linux/libtron_db.so
...
${OBJECTDIR}/src/smarty/learn/Learn.o: src/smarty/learn/Learn.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/Learn.o src/smarty/learn/Learn.cpp

${OBJECTDIR}/src/smarty/learn/State.o: src/smarty/learn/State.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/State.o src/smarty/learn/State.cpp

${OBJECTDIR}/src/smarty/learn/StatePk.o: src/smarty/learn/StatePk.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/StatePk.o src/smarty/learn/StatePk.cpp

${OBJECTDIR}/src/smarty/learn/Task.o: src/smarty/learn/Task.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/Task.o src/smarty/learn/Task.cpp

${OBJECTDIR}/src/smarty/learn/Transition.o: src/smarty/learn/Transition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/Transition.o src/smarty/learn/Transition.cpp

${OBJECTDIR}/src/smarty/learn/TransitionPk.o: src/smarty/learn/TransitionPk.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/TransitionPk.o src/smarty/learn/TransitionPk.cpp

${OBJECTDIR}/src/smarty/learn/db/StateDB.o: src/smarty/learn/db/StateDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn/db
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/db/StateDB.o src/smarty/learn/db/StateDB.cpp

${OBJECTDIR}/src/smarty/learn/db/TaskDB.o: src/smarty/learn/db/TaskDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn/db
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/db/TaskDB.o src/smarty/learn/db/TaskDB.cpp

${OBJECTDIR}/src/smarty/learn/db/TransitionDB.o: src/smarty/learn/db/TransitionDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/smarty/learn/db
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_db/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/smarty/learn/db/TransitionDB.o src/smarty/learn/db/TransitionDB.cpp
